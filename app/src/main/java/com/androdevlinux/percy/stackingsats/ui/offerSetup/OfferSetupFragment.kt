package com.androdevlinux.percy.stackingsats.ui.offerSetup
...
import com.androdevlinux.percy.stackingsats.ui.buySettings.BuySettingsViewModel
import kotlinx.android.synthetic.main.fragment_buy_settings.*

class OfferSetupFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (buySettingsViewModel.appPreferenceManager.weeklyOrMonthly.equals("Weekly", ignoreCase = true)) {
            weeklyMonthlySpinner.setSelection(0)
        } else if (buySettingsViewModel.appPreferenceManager.weeklyOrMonthly.equals("Monthly", ignoreCase = true)) {
        ...
        btnSaveChanges.setOnClickListener {
           ...
           // KotlinUtil.scheduleJob(requireContext())
        }
    }
}